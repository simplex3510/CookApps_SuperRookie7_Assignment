...
public partial class Priest : BaseCharacter
{
    ...
    protected override void InitializeStateDict()
    {
        ...
        StateDict[EState.Idle] = new Priest_IdleState(this);
        StateDict[EState.Move] = new Priest_MoveState(this);
        StateDict[EState.Battle] = new Priest_BattleState(this);
        StateDict[EState.Die] = new Priest_DieState(this);
    }
