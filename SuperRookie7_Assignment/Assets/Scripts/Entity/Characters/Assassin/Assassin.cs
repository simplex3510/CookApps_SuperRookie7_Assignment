...
public partial class Assassin : BaseCharacter
{
    ...
    protected override void InitializeStateDict()
    {
        ...
        StateDict[EState.Idle] = new Assassin_IdleState(this);
        StateDict[EState.Move] = new Assassin_MoveState(this);
        StateDict[EState.Battle] = new Assassin_BattleState(this);
        StateDict[EState.Die] = new Assassin_DieState(this);
    }
